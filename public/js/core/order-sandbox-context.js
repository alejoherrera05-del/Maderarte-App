...
const scopedActions = new Set(['COTIZACION_META','CLIENTES_LISTAR','CLIENTE_OBTENER','ORDEN_CAPACIDADES','ORDEN_CREAR','ORDEN_CREACION_ESTADO','ORDEN_OBTENER','ORDEN_DOCUMENTOS_ESTADO','ORDEN_FOTO_GUARDAR','ORDEN_FOTO_LEER','ORDEN_PDF_LEER','ORDEN_DOCUMENTOS_FINALIZAR']);
