...
try:
 ...
 with sync_playwright() as p:
  ...
  for width in [1916,1366,390,320]:
   ...
   expect(page.locator('#production-workspace')).to_be_visible()
   expect(page.locator('#production-select-0')).to_be_checked()
   expect(page.locator('#production-qty-0')).to_have_value('2')
   expect(page.locator('#production-notice')).not_to_be_checked()
