...
assert.match(trackingHtml, /quote-tracking\.css/);
...
assert.match(trackingJs, /Más de 15 días/);
...
console.log('OK · seguimiento porta radar HomeEasy en modo lectura con antigüedad protegida');
