...
assert.match(documentJs, /Abono para confirmar/);
...
console.log('OK · número protagonista y fecha/sede sin microtipografía');
console.log('OK · total simplificado sin exceso de cifras');
console.log('OK · condiciones con iconos y lectura rápida');
console.log('OK · pie Maddy visible y documental protegido');
