...
assert.match(documentJs, /quote-commercial-conditions/);
assert.match(documentJs, /quote-condition-deposit/);
assert.match(documentJs, /quote-condition-time/);
...
assert.match(documentCss, /grid-template-columns:\s*minmax\(185px/);
...
assert.match(documentCss, /background:\s*transparent/);
assert.match(documentCss, /\.quote-preview-item-index/);
assert.match(documentCss, /\.quote-commercial-conditions/);
assert.match(documentCss, /\.quote-condition > strong/);
...
console.log('OK · cliente editorial sin card genérica');
console.log('OK · items y condiciones comerciales con jerarquía propia');
