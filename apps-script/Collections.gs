...
function colReceive_(p,context){
  ...
  try{
    ...
    colSheet_(true);var result={id:id,requestId:id,total:sum,count:rows.length,date:stamp,by:s.profile.name,branches:Array.from(new Set(rows.map(function(r){return r.Sede;})))};
