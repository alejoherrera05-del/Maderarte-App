...
var OWNER_SANDBOX_ACTIONS_ = Object.freeze(['COTIZACION_META', 'CLIENTES_LISTAR', 'CLIENTE_OBTENER',
  'PRODUCCION_LISTAR','PRODUCCION_CUENTA','PRODUCCION_REGISTRAR','PRODUCCION_REGISTRO_ESTADO','REMISION_CAPACIDADES','REMISION_CUENTA','REMISION_CREAR','REMISION_CREACION_ESTADO','REMISION_OBTENER','REMISION_PDF_LEER','REMISION_DOCUMENTOS_FINALIZAR','INTERNO_REMISION_DOCUMENTO_PREPARAR','INTERNO_REMISION_DOCUMENTO_CONFIRMAR',
