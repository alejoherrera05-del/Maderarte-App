...
var USER_PERMISSION_GROUPS_ = [
  {title:'Nómina · información laboral privada de todas las sedes',sensitive:true,items:[['nomina.read','Consultar nómina y documentos laborales'],['nomina.workers','Administrar trabajadores, salarios y documentos laborales'],['nomina.prepare','Preparar comprobantes'],['nomina.issue','Emitir y anular comprobantes'],['nomina.pay','Confirmar pagos realizados']]},
...
var USER_PERMISSION_DEPS_ = {
  'nomina.workers':['nomina.read','config.read'],'nomina.prepare':['nomina.read'],'nomina.issue':['nomina.read','nomina.prepare'],'nomina.pay':['nomina.read'],
